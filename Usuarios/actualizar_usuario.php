                ...
                <div class="card-body">
                    <form action="/crud-cursos/Usuarios/administrar_usuario.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <?php echo $usuario->getContinua()?>
                            <select type="text" class="form-select" name="continua" value="<?php echo $usuario->getContinua()?>">
                            <option disabled <?php if($usuario->getContinua()==null){?>selected <?php }?>value="2">No definido</option>
                            <option <?php if($usuario->getContinua()==1){?>selected <?php }?>value="1">Si</option>
                            <option <?php if($usuario->getContinua()==2){?>selected <?php }?>value="2">No</option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Ciudades</label>
